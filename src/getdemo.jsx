...
export default function Getdemo() {       // 👈 UPDATED NAME
  ...
  useEffect(() => {
    if (form.noWebsite) setForm((s) => ({ ...s, website: "" }));
  }, [form.noWebsite]);
  ...
  function isValid() {
    ...
    if (!form.designation.trim()) return false;
    if (!form.noWebsite && !form.website.trim()) return false;
    ...
    <div className="signup-wrap">
      <div className="signup-card">
        ...
        <main className="signup-body">
          <h1 className="title">Start free demo</h1>
          <p className="subtitle">Signup with your details to start a free demo</p>
          ...
          <form className="form" onSubmit={handleSubmit} noValidate>
            <div className="grid two">
              <label className="field">
                ...
                <input
                  ...
                  className={touched.firstName && !form.firstName.trim() ? "invalid" : ""}
                />
              ...
              <label className="field">
                ...
                <input
                  ...
                  className={touched.lastName && !form.lastName.trim() ? "invalid" : ""}
                />
            ...
            <div className="grid two">
              <label className="field">
                ...
                <input
                  ...
                  className={touched.org && !form.org.trim() ? "invalid" : ""}
                />
                {touched.org && !form.org.trim() && <div className="err">Required</div>}
              </label>
              ...
              <label className="field">
                ...
                <input
                  ...
                  className={touched.designation && !form.designation.trim() ? "invalid" : ""}
                />
                {touched.designation && !form.designation.trim() && (
                  <div className="err">Required</div>
                )}
              </label>
            </div>
            ...
            <label className="field">
              ...
              <input
                ...
                className={
                  touched.website && !form.noWebsite && !form.website.trim() ? "invalid" : ""
                }
              />
...
<option value="+263">🇿🇼 Zimbabwe (+263)</option>
                ...
                <input
                  ...
                  inputMode="numeric"
                  className={touched.phone && !validPhone(form.phone) ? "invalid" : ""}
                />
              </div>
            </label>

            <button className="submit-btn" type="submit" disabled={disabled}>
              {submitting ? "Starting..." : "Start free demo →"}
            </button>
